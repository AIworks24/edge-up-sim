    ...
    try {
      ...
      const res = await fetch('/api/simulate', {
        ...
        body: JSON.stringify({
          ...
          odds_ml_home:    (oddsData.moneyline_home != null && (oddsData.moneyline_home <= -100 || oddsData.moneyline_home >= 100)) ? oddsData.moneyline_home : -150,
          odds_ml_away:    (oddsData.moneyline_away != null && (oddsData.moneyline_away <= -100 || oddsData.moneyline_away >= 100)) ? oddsData.moneyline_away : 130,
